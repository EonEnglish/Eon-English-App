...
process.env.FIREBASE_PROJECT_ID = "eon-english-app";
process.env.FIREBASE_AUTH_DOMAIN = "eon-english-app.firebaseapp.com";
process.env.FIREBASE_STORAGE_BUCKET = "eon-english-app.appspot.com";
process.env.FIREBASE_APP_ID = "1:894295453065:web:4f3045d2716f6894790558";
process.env.FIREBASE_API_KEY = "AIzaSyA2CekCV9iouIPEFpSeCj46ljctTMb3kmQ";
process.env.FIREBASE_MESSAGING_SENDER_ID = "894295453065";
